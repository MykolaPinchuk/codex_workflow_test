...
- Outcome:
  - Succeeded; created local artifacts under `runs/smoke_agent01/`, `runs/smoke_xgb_agent01/`, `runs/smoke_dgp008_default08_agent05/`, and `sweeps/smoke_sweep_agent01/` (gitignored).
