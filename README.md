...
- Run a parametric DGP: `python3 -m dgp_xgb --dgp dgp008_parametric_ripple --dgp-params complexity=1.5`
- Default `complexity` for `dgp008_parametric_ripple` is 2.2 when omitted.
